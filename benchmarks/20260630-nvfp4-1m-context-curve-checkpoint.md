...
The number nobody published. The community headline (~67 t/s) is measured near the top of the
...
| context depth | single-stream t/s | mean draft-accept | per-position acceptance (pos 0..4) |
| ---: | ---: | ---: | --- |
